...
export const speakText = async (text, voice = 'nova', speed = 1.0) => {
  try {
    console.log(`음성 생성 요청: ${voice} 음성으로 "${text.substring(0, 30)}${text.length > 30 ? '...' : ''}" 변환 시작 (속도: ${speed}x)`);
